...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/snake_rpi: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/snake_rpi ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/rpi_hard.o: rpi_hard.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rpi_hard.o rpi_hard.c
...
${OBJECTDIR}/snake_rpi.o: snake_rpi.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/snake_rpi.o snake_rpi.c

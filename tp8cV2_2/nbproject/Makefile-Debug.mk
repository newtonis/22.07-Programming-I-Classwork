...
${OBJECTDIR}/_ext/d13e46b2/graphic.o: ../tp8cV2/graphic.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d13e46b2/graphic.o ../tp8cV2/graphic.c

${OBJECTDIR}/_ext/d13e46b2/input.o: ../tp8cV2/input.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d13e46b2
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d13e46b2/input.o ../tp8cV2/input.c

${OBJECTDIR}/_ext/d13e46b2/nonblock.o: ../tp8cV2/nonblock.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d13e46b2
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d13e46b2/nonblock.o ../tp8cV2/nonblock.c

${OBJECTDIR}/_ext/d13e46b2/output.o: ../tp8cV2/output.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d13e46b2
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d13e46b2/output.o ../tp8cV2/output.c

${OBJECTDIR}/_ext/d13e46b2/port_utils.o: ../tp8cV2/port_utils.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d13e46b2
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d13e46b2/port_utils.o ../tp8cV2/port_utils.c
...
${OBJECTDIR}/main2.o: main2.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main2.o main2.c
